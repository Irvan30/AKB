...
import com.kokom.mvputsakb.DetailTeman;
...
public class ListTemanAdapter extends RecyclerView.Adapter<ListTemanAdapter.CategoryViewHolder> {
    ...
    public void onBindViewHolder(@NonNull CategoryViewHolder categoryViewHolder, int position) {
        ...
        categoryViewHolder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(v.getContext(), PresenterDetailTeman.class);
    ...
    class CategoryViewHolder extends RecylerView.ViewHolder {
        TextView tvNIM;
        TextView tvNama;
